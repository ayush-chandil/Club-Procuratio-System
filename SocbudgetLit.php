...
<body>
           ...
           <div class="box">
               <h3 class="mb-2">Total Society Budget</h3>
                ...
                <select name="select1" id="select1" onchange="showList(this.value)">
                        ...
                        <option value="LITERATURE_COMMITTEE">LITERATURE COMMITTEE</option>
                        <option value="POETRY_CLUB">POETRY CLUB</option>
                ...
                <a href="LitBudget.php" class="btn mt-5" type="button">EDIT BUDGET</a>
    ...
    <script>
        ...
        if (str.length == 0) {
            ...
            xmlhttp.open("GET", "getBudgetLit.php?q=" + str, true);
            xmlhttp.send();

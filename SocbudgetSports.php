...
<body>
           ...
           <div class="box">
               <h3 class="mb-2">Total Society Budget</h3>
                ...
                <select name="select1" id="select1" onchange="showList(this.value)">
                        ...
                        <option value="SPORTS_COMMITTEE">SPORTS COMMITTEE</option>
                        <option value="CRICKET_CLUB">CRICKET CLUB</option>
                ...
                <a href="SportsBudget.php" class="btn mt-5" type="button">EDIT BUDGET</a>
    ...
    <script>
        ...
        if (str.length == 0) {
            ...
            xmlhttp.open("GET", "getBudgetSports.php?q=" + str, true);
            xmlhttp.send();
